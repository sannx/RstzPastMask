...
```{r plotAreaDif, echo=FALSE, cache=TRUE, fig.height=6, fig.width=14, fig.align="center"}
...
```{r plotAreaPerc, echo=FALSE, cache=TRUE, fig.height=7, fig.width=12, fig.align="center"}
# par(mfrow = c(1,2))
...
```{r plotArea, echo=FALSE, cache=TRUE, fig.height=6, fig.width=14, fig.align="center"}
# par(mfrow = c(1,2))
...
```{r shpHom5, echo=TRUE, cache=TRUE, fig.height=9, fig.width=9, fig.align="center"}
# par(mfrow = c(1,2))
plot(shpHom5, col = 'red', main = "Figura 12 a: diferença entre 5_250 e 10_250")
plot(shpHom10 , col = alpha('blue', 0.5), add = TRUE)
plot(shpHom, col = alpha('yellow', 0.5), add = TRUE)

plot(shpHom5, col = 'red', main = "Figura 12 b:  diferença entre 5_250 e 50_250")
plot(shpHom50 , col = alpha('darkorange', 0.5), add = TRUE)
plot(shpHom, col = alpha('yellow', 0.5), add = TRUE)
```
...
```{r shpHom10, echo=TRUE, cache=TRUE, fig.height=9, fig.width=9, fig.align="center"}
plot(shpHom10, col = 'blue', main = "Figura 13:  diferença entre 10_250 e 50_250")
plot(shpHom50 , col = alpha('darkorange', 0.5), add = TRUE)
plot(shpHom, col = alpha('yellow', 0.5), add = TRUE)
